...
export default function CompletePage() {
  ...
  useEffect(() => {
    ...
    const quizStored = sessionStorage.getItem('tickets_quiz');
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white shadow-sm">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-[#1a2f5e]">Rentals Induction</h1>
        ...
        <div className="w-full max-w-lg space-y-4">
          <div className="bg-[#1a2f5e] rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-blue-200 text-sm mt-2">
              You have successfully completed the Rainbow Ski Area Ticket Office induction.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 space-y-4">
            <div className="border-2 border-[#1a2f5e] rounded-xl p-5 text-center space-y-1">
              ...
              <div className="text-sm font-medium text-gray-700 mt-2">Rainbow Ski Area · Ticket Office Induction 2026</div>
              {quiz && (
            ...
            <div className="bg-blue-50 rounded-xl p-4">
              ...
              <ul className="space-y-1.5 text-sm text-gray-600">
                <li className="flex items-start gap-2"><span>•</span><span>Inform your supervisor that you have completed the Ticket Office induction</span></li>
                ...
                <li className="flex items-start gap-2"><span>•</span><span>Refer back to the Section H manual for guidance at any time</span></li>
